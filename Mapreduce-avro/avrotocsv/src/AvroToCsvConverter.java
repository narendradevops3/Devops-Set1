...
public class AvroToCsvConverter {
	...
	public static void main(String[] args) {
		...
		File[] listoffiles = finder("/home/cloudera/Documents/samplepartd/");
	...
	private static void readAvroFile(String strFile) throws IOException {
		...
		Record r1;
		Record r2;
		GenericData.Array<GenericRecord> recValue;

		File res_file = new File(
				"/home/cloudera/Documents/samplepartd/" + countfiles
						+ ".csv");
		...
		while (dataFileReader.hasNext()) {
			...
			recValue = (GenericData.Array<GenericRecord>) r.get("value");
